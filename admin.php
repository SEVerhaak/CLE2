...
<div class="admin-box">
    ...
    <section class="admin-section2">
        ...
        <img id="important-image" src="img/dc6.gif"
             style="margin-top: 10rem; width: 300px; visibility: hidden; display: none;">
        <script>
            ...
            <?php for ($x = 0; $x < 2; $x++) { ?>
                <div class="message">
                    ...
                    <div>
                        ...
                        <a class="button-user-edit" id="button-user-edit"
                           href="<?= "editUser.php?id=" . $users[$x]['id']; ?>">Edit</a>
                    </div>
                </div>
            <?php } ?>
