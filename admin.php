...
$calendar->add_event('Workshop', '2024-01-03', 1, 'green');
$calendar->add_event('Catering', '2024-01-07', 1, 'yellow');
$calendar->add_event('Workshop', '2024-01-23', 1, 'green');
$calendar->add_event('Catering', '2024-01-31', 1, 'yellow');
?>
